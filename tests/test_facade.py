...
lives in the dedicated test modules; this file only defends the wiring.
"""
...
from zerofilesystem._platform import IS_LINUX, IS_MACOS

# Every public helper on ZeroFS that is meant to be the same callable as the
# top-level zerofilesystem.<name> alias. Constructors are listed separately
# below because they wrap the underlying class rather than aliasing it.
ALIASED_METHODS = [
    "read_text",
    "write_text",
    "read_bytes",
